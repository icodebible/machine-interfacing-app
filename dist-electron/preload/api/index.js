...
exports.api = {
    ...
    machinesLogsHostInfo: (machineId) => electron_1.ipcRenderer.invoke(channels_1.IPC_CHANNELS.MACHINES_LOGS_HOST_INFO, machineId),
    machinesLogsOpenFolder: (machineId) => electron_1.ipcRenderer.invoke(channels_1.IPC_CHANNELS.MACHINES_LOGS_OPEN_FOLDER, machineId),
    machinesLogsOpenRawFolder: (machineId) => electron_1.ipcRenderer.invoke(channels_1.IPC_CHANNELS.MACHINES_LOGS_OPEN_RAW_FOLDER, machineId),
