...
exports.appAPI = exports.api = void 0;
...
exports.api = {
    ...
    machinesLogsReplay: (logId, mode) => electron_1.ipcRenderer.invoke(channels_1.IPC_CHANNELS.MACHINES_LOGS_REPLAY, logId, mode),
    machinesRuntimeSessionsList: (machineId, limit) => electron_1.ipcRenderer.invoke(channels_1.IPC_CHANNELS.MACHINES_SESSIONS_LIST, machineId, limit),
    ...
    machinesSimUseCasesList: (machineId) => electron_1.ipcRenderer.invoke(channels_1.IPC_CHANNELS.MACHINES_SIM_USE_CASES_LIST, machineId),
    machinesSimUseCaseSave: (dto) => electron_1.ipcRenderer.invoke(channels_1.IPC_CHANNELS.MACHINES_SIM_USE_CASE_SAVE, dto),
    machinesSimUseCaseDelete: (id) => electron_1.ipcRenderer.invoke(channels_1.IPC_CHANNELS.MACHINES_SIM_USE_CASE_DELETE, id),
    machinesSimUseCaseRun: (machineId, useCaseId, variables) => electron_1.ipcRenderer.invoke(channels_1.IPC_CHANNELS.MACHINES_SIM_USE_CASE_RUN, machineId, useCaseId, variables),
    machinesSimRunHistory: (machineId, limit) => electron_1.ipcRenderer.invoke(channels_1.IPC_CHANNELS.MACHINES_SIM_RUN_HISTORY, machineId, limit),
    ...
    auditEventsQuery: (q = {}) => electron_1.ipcRenderer.invoke(channels_1.IPC_CHANNELS.AUDIT_EVENTS_QUERY, q),
    auditEventsSummary: (days) => electron_1.ipcRenderer.invoke(channels_1.IPC_CHANNELS.AUDIT_EVENTS_SUMMARY, days),
    deploymentReadinessCheck: () => electron_1.ipcRenderer.invoke(channels_1.IPC_CHANNELS.DEPLOYMENT_READINESS_CHECK),
    appDiagnosticsGet: () => electron_1.ipcRenderer.invoke(channels_1.IPC_CHANNELS.APP_DIAGNOSTICS_GET),
    databaseBackupCreate: () => electron_1.ipcRenderer.invoke(channels_1.IPC_CHANNELS.APP_DATABASE_BACKUP_CREATE),
    ...
    lisTestOrderProfilesList: (targetId) => electron_1.ipcRenderer.invoke(channels_1.IPC_CHANNELS.LIS_TEST_ORDER_PROFILES_LIST, targetId ?? null),
...
// Compatibility aliases for preload/import consumers.
exports.appAPI = exports.api;
