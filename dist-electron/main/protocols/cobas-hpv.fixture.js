...
exports.COBAS_HPV_ACTUAL_TEMPLATE = exports.COBAS_HPV_SIMULATION_SAMPLE_ID = void 0;
exports.renderCobasHpvActualResult = renderCobasHpvActualResult;
exports.COBAS_HPV_SIMULATION_SAMPLE_ID = 'NPHL/26/0000058';
...
const obx = (setId, code, result) => `OBX|${setId}|ST|${code}^${code}^99ROC||ValueNotSet|||${result}|||F|||||DataManager-100340||C6800/8800^Roche^^~Unknown^Roche^^~ID_000000000012076380^IM300-001794^^|{{observedAt}}|||||||||10196_neg^^99ROC~10195_pos^^99ROC`;
const segments = [
 ...
 */
exports.COBAS_HPV_ACTUAL_TEMPLATE = `\x0b${segments.join('\r')}\r\x1c\r`;
function renderCobasHpvActualResult(input) {
    const values = {
        sampleId: String(input.sampleId || exports.COBAS_HPV_SIMULATION_SAMPLE_ID),
    ...
    return exports.COBAS_HPV_ACTUAL_TEMPLATE.replace(/\{\{([a-zA-Z0-9_]+)\}\}/g, (_match, key) => values[key] ?? '');
}
