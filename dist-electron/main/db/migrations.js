...
// ensureActorColumns(db, 'lis_test_order_profiles');
...
//         CREATE INDEX IF NOT EXISTS idx_routing_rules_lab
//         ON routing_rules(lab_id);
//         CREATE INDEX IF NOT EXISTS idx_routing_rules_test_code
//         ON routing_rules(test_code);
//         CREATE TABLE IF NOT EXISTS delivery_audit_logs (
//         id TEXT PRIMARY KEY,
//         queue_id TEXT NOT NULL,
//         target_id TEXT NOT NULL,
...
async function runMigrations() {
    ...
    db.exec(`
        ...
        CREATE UNIQUE INDEX IF NOT EXISTS idx_lis_test_order_profiles_target_order
        ON lis_test_order_profiles(target_id, order_concept_uuid);

        CREATE INDEX IF NOT EXISTS idx_lis_test_order_profiles_target_enabled
        ON lis_test_order_profiles(target_id, enabled, profile_code);
        ...
        CREATE UNIQUE INDEX IF NOT EXISTS idx_lis_test_order_profile_parameters_code
        ON lis_test_order_profile_parameters(profile_id, analyzer_code);
...
function ensureActorColumns(db, table, includeUpdated = true) {
