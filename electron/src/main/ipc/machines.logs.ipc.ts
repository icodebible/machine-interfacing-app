...
export function registerMachinesLogsIpc() {
    ...
    safeHandle(IPC_CHANNELS.MACHINES_LOGS_HOST_INFO, (_e: any, machineId: string) =>
        machineHostLogService.getInfo(machineId),
    );

    safeHandle(IPC_CHANNELS.MACHINES_LOGS_OPEN_FOLDER, (_e: any, machineId: string) =>
        machineHostLogService.openMachineDirectory(machineId),
    );

    safeHandle(IPC_CHANNELS.MACHINES_LOGS_OPEN_RAW_FOLDER, (_e: any, machineId: string) =>
        machineHostLogService.openRawMachineDirectory(machineId),
    );
