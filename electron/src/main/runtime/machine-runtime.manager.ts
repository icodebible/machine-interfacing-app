...
//     startSimulation(machineId: string, scenario?: MachineSimulationScenario, intervalMs = 5000) {
//         const machine: any = this.machinesService.list().find((m: any) => m.id === machineId);
...
//     restartSimulation(machineId: string, scenario?: MachineSimulationScenario, intervalMs = 5000) {
//         const machine: any = this.machinesService.list().find((m: any) => m.id === machineId);
