...
import { Hl7MllpStreamDecoder } from '../protocols/hl7-mllp-stream.decoder';
...
export class MachineRuntimeManager {
    ...
    private mllpDecoders = new Map<string, Hl7MllpStreamDecoder>();
                ...
                case 'HL7_MLLP': {
                    ...
                    tcpSession.start(
                        ...
                        (msg: any) => {
                            ...
                            const decoder = this.mllpDecoders.get(decoderKey) ?? new Hl7MllpStreamDecoder();
                            ...
                            frames.forEach((frame, frameIndex) => {
                                ...
                                if (result.normalized) reportableCount += 1;
    ...
    private processIncomingPayload(input: ProcessPayloadInput) {
        ...
        try {
            ...
            const classification = parsed.protocol === 'HL7' ? classifyHl7Result(parsed) : null;
