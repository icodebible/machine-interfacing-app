...
export const api: AppAPI = {
  ...
  tcpSend: (payload) =>
    ipcRenderer.invoke(IPC_CHANNELS.MACHINE_TCP_SEND, payload),
  tcpDisconnect: () => ipcRenderer.invoke(IPC_CHANNELS.MACHINE_TCP_DISCONNECT),
  ...
  serialConnect: (path, baudRate) =>
    ipcRenderer.invoke(IPC_CHANNELS.MACHINE_SERIAL_CONNECT, { path, baudRate }),
  serialSend: (payload) =>
    ipcRenderer.invoke(IPC_CHANNELS.MACHINE_SERIAL_SEND, payload),
  serialDisconnect: () =>
    ipcRenderer.invoke(IPC_CHANNELS.MACHINE_SERIAL_DISCONNECT),

  onMachineMessage: (cb) => {
    const handler = (_: any, msg: any) => cb(msg);
    ipcRenderer.on(IPC_CHANNELS.MACHINE_MESSAGE, handler);
    return () =>
      ipcRenderer.removeListener(IPC_CHANNELS.MACHINE_MESSAGE, handler);
  },
  ...
  labsCreate: (dto) => ipcRenderer.invoke(IPC_CHANNELS.LABS_CREATE, dto),
  labsUpdate: (id, dto) =>
    ipcRenderer.invoke(IPC_CHANNELS.LABS_UPDATE, id, dto),
  labsDelete: (id) => ipcRenderer.invoke(IPC_CHANNELS.LABS_DELETE, id),
  ...
  machinesList: () => ipcRenderer.invoke(IPC_CHANNELS.MACHINES_LIST),
  machinesCreate: (dto) =>
    ipcRenderer.invoke(IPC_CHANNELS.MACHINES_CREATE, dto),
  machinesUpdate: (id, dto) =>
    ipcRenderer.invoke(IPC_CHANNELS.MACHINES_UPDATE, id, dto),
  machinesDelete: (id) => ipcRenderer.invoke(IPC_CHANNELS.MACHINES_DELETE, id),
  machinesConnect: (id) =>
    ipcRenderer.invoke(IPC_CHANNELS.MACHINES_CONNECT, id),
  machinesDisconnect: (id) =>
    ipcRenderer.invoke(IPC_CHANNELS.MACHINES_DISCONNECT, id),
  machinesTest: (machine) =>
    ipcRenderer.invoke(IPC_CHANNELS.MACHINES_TEST, machine),

  // ✅ Targets
  targetsList: () => ipcRenderer.invoke(IPC_CHANNELS.TARGETS_LIST),
  targetsCreate: (dto) => ipcRenderer.invoke(IPC_CHANNELS.TARGETS_CREATE, dto),
  targetsUpdate: (id, dto) =>
    ipcRenderer.invoke(IPC_CHANNELS.TARGETS_UPDATE, id, dto),
  targetsDelete: (id) => ipcRenderer.invoke(IPC_CHANNELS.TARGETS_DELETE, id),
  targetsTest: (id) => ipcRenderer.invoke(IPC_CHANNELS.TARGETS_TEST, id),
  ...
  logsQuery: (q) => ipcRenderer.invoke(IPC_CHANNELS.LOGS_QUERY, q),
  deliveryAuditList: (q) =>
    ipcRenderer.invoke(IPC_CHANNELS.DELIVERY_AUDIT_LIST, q),

  machinesRuntimeStart: (id) =>
    ipcRenderer.invoke(IPC_CHANNELS.MACHINES_RUNTIME_START, id),
  machinesRuntimeStop: (id) =>
    ipcRenderer.invoke(IPC_CHANNELS.MACHINES_RUNTIME_STOP, id),
  machinesRuntimeRestart: (id) =>
    ipcRenderer.invoke(IPC_CHANNELS.MACHINES_RUNTIME_RESTART, id),
  machinesRuntimeState: (id) =>
    ipcRenderer.invoke(IPC_CHANNELS.MACHINES_RUNTIME_STATE, id),
  machinesRuntimeStates: () =>
    ipcRenderer.invoke(IPC_CHANNELS.MACHINES_RUNTIME_STATES),
  ...
  machinesLogsClear: (machineId) =>
    ipcRenderer.invoke(IPC_CHANNELS.MACHINES_LOGS_CLEAR, machineId),
  ...
  machinesSimStop: (machineId) =>
    ipcRenderer.invoke(IPC_CHANNELS.MACHINES_SIM_STOP, machineId),
  ...
  machinesSimState: (machineId) =>
    ipcRenderer.invoke(IPC_CHANNELS.MACHINES_SIM_STATE, machineId),
  ...
  approvalPoliciesList: () =>
    ipcRenderer.invoke(IPC_CHANNELS.APPROVAL_POLICIES_LIST),

  approvalPoliciesCreate: (dto) =>
    ipcRenderer.invoke(IPC_CHANNELS.APPROVAL_POLICIES_CREATE, dto),
  ...
  resultApprove: (dto: any) =>
    ipcRenderer.invoke(IPC_CHANNELS.RESULT_APPROVE, dto),

  resultReject: (dto: any) =>
    ipcRenderer.invoke(IPC_CHANNELS.RESULT_REJECT, dto),

  resultApprovalsList: (normalizedResultId: any) =>
    ipcRenderer.invoke(IPC_CHANNELS.RESULT_APPROVALS_LIST, normalizedResultId),

  outboundQueueList: (limit: any) =>
    ipcRenderer.invoke(IPC_CHANNELS.OUTBOUND_QUEUE_LIST, limit),
  ...
  deliveryAuditQuery: (q: any) =>
    ipcRenderer.invoke(IPC_CHANNELS.DELIVERY_AUDIT_QUERY, q),
  ...
  mappingsCreate: (dto: any) =>
    ipcRenderer.invoke(IPC_CHANNELS.MAPPINGS_CREATE, dto),
  mappingsUpdate: (id: string, dto: any) =>
    ipcRenderer.invoke(IPC_CHANNELS.MAPPINGS_UPDATE, id, dto),
  mappingsDelete: (id: string) =>
    ipcRenderer.invoke(IPC_CHANNELS.MAPPINGS_DELETE, id),
  mappingsValidate: (targetType: string) =>
    ipcRenderer.invoke(IPC_CHANNELS.MAPPINGS_VALIDATE, targetType),
  mappingsOpenMrsLisDiscover: (dto: any) =>
    ipcRenderer.invoke(IPC_CHANNELS.MAPPINGS_OPENMRS_LIS_DISCOVER, dto),
  ...
  usersCreate: (dto) => ipcRenderer.invoke(IPC_CHANNELS.USERS_CREATE, dto),
  usersUpdate: (id, dto) =>
    ipcRenderer.invoke(IPC_CHANNELS.USERS_UPDATE, id, dto),
  usersResetPassword: (id, newPassword) =>
    ipcRenderer.invoke(IPC_CHANNELS.USERS_RESET_PASSWORD, id, newPassword),
  usersDelete: (id) => ipcRenderer.invoke(IPC_CHANNELS.USERS_DELETE, id),
  ...
  rolesAuthoritiesCatalog: () =>
    ipcRenderer.invoke(IPC_CHANNELS.ROLES_AUTHORITIES_CATALOG),
  rolesCreate: (dto) => ipcRenderer.invoke(IPC_CHANNELS.ROLES_CREATE, dto),
  rolesUpdate: (id, dto) =>
    ipcRenderer.invoke(IPC_CHANNELS.ROLES_UPDATE, id, dto),
  rolesDelete: (id) => ipcRenderer.invoke(IPC_CHANNELS.ROLES_DELETE, id),
