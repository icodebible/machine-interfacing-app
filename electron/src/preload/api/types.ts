...
// //     outboundQueueSendNow: (queueId: string) => Promise<boolean>;
    outboundQueueRebuildPayload: (queueId: string) => Promise<OutboundQueueRow>;
...
export type LisTestOrderProfileParameter = {
    id?: string | null;
    ...
    datatype?: string | null;
    value_type: 'coded' | 'numeric' | 'text' | string;
    required: number;
...
export type LisTestOrderProfileRow = {
    id: string;
    target_id: string;
    target_name?: string | null;
    ...
    order_name_includes_json?: string | null;
    enabled: number;
    parameters: LisTestOrderProfileParameter[];
    created_at: string;
    updated_at: string;
    created_by_user_id?: string | null;
    created_by_username?: string | null;
...
export type LisTestOrderProfileInput = {
    ...
    parameters?: Array<Partial<LisTestOrderProfileParameter> & {
...
export type AppAPI = {
    ...
    }) => Promise<OpenMrsLisMetadataResponse>;
    mappingsOpenMrsLisSeed: (dto: OpenMrsLisMappingSeedInput) => Promise<OpenMrsLisMappingSeedResult>;
    lisTestOrderProfilesList: (targetId?: string | null) => Promise<LisTestOrderProfileRow[]>;
    lisTestOrderProfileGet: (id: string) => Promise<LisTestOrderProfileRow | null>;
    lisTestOrderProfileSave: (payload: LisTestOrderProfileInput) => Promise<LisTestOrderProfileRow>;
    lisTestOrderProfileSetEnabled: (id: string, enabled: number) => Promise<boolean>;
    ...
    routingRulesUpdate: (id: string, patch: Partial<RoutingRuleInput>) => Promise<RoutingRuleRow>;
    routingRulesDelete: (id: string) => Promise<boolean>;
    routingRulesPreviewResult: (normalizedResultId: string, fallbackTargetIds?: string[]) => Promise<any>;
